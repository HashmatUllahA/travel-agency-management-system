    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5 text-right">
                <p>Date: {{ $returnpayment->created_at }}</p>
        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-5 ml-2">
                    <p><strong>Customer Name:</strong>{{ $returnpayment->id }}</p>
                    <p><strong>Father Name:</strong>  {{ $returnpayment->fathername }}</p>
                    <p><strong>Passport No:</strong>  {{ $returnpayment->passportno }}</p>
                    <p><strong>Contect No:</strong> {{ $returnpayment->contect }}</p>
                    <p><strong>Address:</strong> {{ $returnpayment->city }}</p>
                </div>

                 <div class="col-md-5 text-right slip-body">
                    <p><strong>Status:</strong> {{ $returnpayment->trade }}</p>
                    <p><strong>Payment Method:</strong> {{ $returnpayment->paymentstutas }}</p>
            ...
            <div class="row">
                <div class="col-md-12">
                    <p><strong>Country:</strong> Payment for {{ $returnpayment->country }}</p>
                    <p><strong>Company Name:</strong> Payment for <b>({{ $returnpayment->companyname }})</b></p>
                    <p><strong>Message:</strong> to remember <b>({{ $returnpayment->msg }})</b></p>
                </div>
            </div>
