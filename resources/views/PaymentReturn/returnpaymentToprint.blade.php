<x-layoutadmin>
    <x-slot name="title">viewreturnbyid</x-slot>
    <x-slot name="body">
    ...
    {{-- <p>Remaining Payment: {{ $remainingAmount }}</p> --}}
            <div class="container">
                <a href="{{ route('return.pdf', ['id' => $result->id]) }}">
                    ...
                    <div class="slip-body">
                        <div class="row">
                            ...
                            <div class="col-md-5 text-right">
                                ...
                                <p><strong>Return Payment:</strong> {{ $result->returnpayment }}</p>
                                <p><strong>Recive Amount:</strong></p>
