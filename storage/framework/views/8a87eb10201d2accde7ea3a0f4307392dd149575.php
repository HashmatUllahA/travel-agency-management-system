            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header d-flex">
                    <h5>URGENT NEED OF <?php echo e($images->title); ?> IN -<?php echo e($images->country); ?></h5>
                ...
                <div class="card-body">
                            ...
                            <img src="<?php echo e(asset($images->image_path)); ?>" alt="" width="1100px" height="500px"> 
                            <td></td>    
...
<?php /**PATH J:\pfi\resources\views/USER/showadvimag.blade.php ENDPATH**/ ?>