...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> All vasa <?php $__env->endSlot(); ?>
        ...
        <tbody>  
            ...
            <td><?php echo e($loop->iteration); ?>
                ...
                <div style="" class="edtdeletebtn d-flex">
                    <td>
                        <a href="editvias/<?php echo e($value->id); ?>"><button class="EDBTN btn-info">Edit</button></a>
                        <a href="deletevisa/<?php echo e($value->id); ?>"><button class="EDBTN btn-danger">Delete</button></a>
                    </td>
                    </div>
            </tr>
...
<?php endif; ?><?php /**PATH J:\pfi\resources\views/VISA/allvisa.blade.php ENDPATH**/ ?>