...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> all Return p table <?php $__env->endSlot(); ?>
...
<table id="myTable" class="table table-striped" >
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($value->retunpayment); ?></td>
                
                <td><?php echo e($value->created_at->format('d M Y')); ?></td>
                <div style="" class="edtdeletebtn d-flex">
                    <td>
                        <a href="returnpayment/<?php echo e($value->id); ?>"><button class="EDBTN btn-info w-60">view</button></a>
...
<?php endif; ?>
<?php /**PATH J:\pfi\resources\views/PaymentReturn/showAllReturnPayment.blade.php ENDPATH**/ ?>