...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> getreturn passport <?php $__env->endSlot(); ?>
        ...
        <tbody>
            ...
            <tr>
                ...
                <div style="" class="edtdeletebtn d-flex">
                    <td>
                        <a href="deletpassport/<?php echo e($value->id); ?>"><button class="EDBTN btn-danger">Delete</button></a>
                    </td>
                    </div>
...
<?php endif; ?>
<?php /**PATH J:\pfi\resources\views/PASSPORT/getreturnpassport.blade.php ENDPATH**/ ?>